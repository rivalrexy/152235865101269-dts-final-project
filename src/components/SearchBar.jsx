...
import { passCountry } from "../redux/country";
      ...
      <div className="flex flex-row justify-center">
        <div className="xl:w-96">
          <div className="input-group relative flex items-stretch w-full mb-4">
            ...
            />
            <button
              className="btn px-6 ml-1 py-2.5 bg-gray-600 text-white font-medium text-xs leading-tight uppercase rounded shadow-md hover:bg-gray-700 hover:shadow-lg focus:bg-gray-700  focus:shadow-lg focus:outline-none focus:ring-0 active:bg-gray-800 active:shadow-lg transition duration-150 ease-in-out flex items-center"
              type="button"
              id="button-addon2"
              onClick={() => dispatch(passCountry(localCountry))}>
              <svg
                aria-hidden="true"
                focusable="false"
                data-prefix="fas"
